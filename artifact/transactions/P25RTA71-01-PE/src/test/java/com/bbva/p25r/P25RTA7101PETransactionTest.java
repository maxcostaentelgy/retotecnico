...
/**
 * Test for transaction P25RTA7101PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/P25RTA7101PETest.xml" })
public class P25RTA7101PETransactionTest {

	@Autowired
	private P25RTA7101PETransaction transaction;
	...
	public void testNotNull(){
		...
		Mockito.verify(p25rRA61).executeUpdateCustomer(Mockito.same(entityInDTO));
	}
